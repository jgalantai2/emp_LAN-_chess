...
namespace ChessSrv
{
    ...
    class ChessServer
    {
        ...
        public ChessServer(IPAddress address)
        {
            ipAddress = address;
        }
        ...
        public static void AddUser(TcpClient tcpUser, string strUsername)
        {
            ...
            ChessServer.htUsers.Add(strUsername, tcpUser);
            ChessServer.htConnections.Add(tcpUser, strUsername);
        ...
        public static void RemoveUser(TcpClient tcpUser)
        {
            ...
            if (htConnections[tcpUser] != null)
            {
                ...
                ChessServer.htUsers.Remove(ChessServer.htConnections[tcpUser]);
                ChessServer.htConnections.Remove(tcpUser);
            }
        }
        ...
        public static void SendAdminMessage(string Message)
        {
            ...
            TcpClient[] tcpClients = new TcpClient[ChessServer.htUsers.Count];
            // Copy the TcpClient objects into the array
            ChessServer.htUsers.Values.CopyTo(tcpClients, 0);
    ...
    class Connection
    {
        ...
        private void AcceptClient()
        {
            ...
            if (currUser != "")
            {
                ...
                if (ChessServer.htUsers.Contains(currUser) == true)
                {
                ...
                else
                {
                    ...
                    ChessServer.AddUser(tcpClient, currUser);
                }
            }
            else
            {
            ...
            try
            {
                ...
                while ((strResponse = srReceiver.ReadLine()) != "")
                {
                    ...
                    if (strResponse == null)
                    {
                        ChessServer.RemoveUser(tcpClient);
                    }
                    else
                    {
                        // Otherwise send the message to all the other users
                        ChessServer.SendMessage(currUser, strResponse);
                    }
                }
            }
            catch
